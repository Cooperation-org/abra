...
```
                  view (canvas, components — Pinterest, journal, digest)
                                  ▲
                                  │ reads
                                  │
                       ┌────────────────────────────────────┐
                       │  ABRA — the map                    │
                       │                                    │
                       │    pet name  ──(binding)──→ thing  │
                       │    hot tags · pinning              │
                       └────────────────────────────────────┘
                                  ▲
                                  │ open — any system writes,
                                  │ every binding carries who wrote it
                                  │
                          me · amebo · friends · importers
```
